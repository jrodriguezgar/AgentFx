...
def string_merge(string1: str, string2: str, base: Optional[str] = None) -> str:
    ...
    if base_idx < len(base):
        output.append(# filepath: c:\apps\onedrive\OneDrive - Atresmedia Corporacion De Medios De Comunicacion SA\dev\git\DatamanEdge\FormuLite\formulite\fxString\string_operations.py
# ...existing code...
def string_merge(string1: str, string2: str, base: Optional[str] = None) -> str:
    """
    Merges two strings based on a common base string (3-way merge).
