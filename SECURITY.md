...
Please report vulnerabilities via [GitHub Security Advisories](https://github.com/jrodriguezgar/FormuLite/security/advisories/new).
...
FormuLite follows these security guidelines:
