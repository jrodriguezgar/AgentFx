...
|-------|---------|---------|
| `mcp` | `pip install formulite[mcp]` | MCP server for AI agents |
| `semantic` | `pip install formulite[semantic]` | Semantic search via fastembed |
| `mcp-semantic` | `pip install formulite[mcp-semantic]` | MCP + semantic search |
| `scipy` | `pip install formulite[scipy]` | SciPy-backed statistical functions |
| `similarity` | `pip install formulite[similarity]` | Advanced string similarity |
| `all` | `pip install formulite[all]` | Everything |
