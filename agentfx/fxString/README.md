...
Complete reference for all string manipulation, conversion, validation, and formatting functions in the AgentFx fxString module.

## Overview

The fxString module provides comprehensive string manipulation functions for AgentFx, including:
...
> Some algorithms (Metaphone, Levenshtein, Jaro-Winkler) require optional third-party libraries. If missing, the library logs an install instruction and returns ``None``. AgentFx never installs packages automatically.
...
**Ejemplo:**
```python
from agentfx.fxString.string_format import camel_to_snake
...
**Ejemplo:**
```python
from agentfx.fxString.string_convertions import char_from_code
...
**Ejemplo:**
```python
from agentfx.fxString.string_convertions import code_from_char
...
**Ejemplo:**
```python
from agentfx.fxString.string_evaluations import count_sentences
...
**Ejemplo:**
```python
from agentfx.fxString.string_encoding import decode_base64
...
**Ejemplo:**
```python
from agentfx.fxString.string_encoding import decode_url
...
**Ejemplo:**
```python
from agentfx.fxString.string_format import dollar
...
**Ejemplo:**
```python
from agentfx.fxString.string_encoding import encode_base64
...
**Ejemplo:**
```python
from agentfx.fxString.string_encoding import encode_url
...
**Ejemplo:**
```python
from agentfx.fxString.string_operations import extract_urls
...
**Ejemplo:**
```python
from agentfx.fxString.string_format import fixed
...
**Ejemplo:**
```python
from agentfx.fxString.string_format import format_as_currency
...
**Ejemplo:**
```python
from agentfx.fxString.string_evaluations import is_credit_card_format
...
**Ejemplo:**
```python
from agentfx.fxString.string_evaluations import is_ipv4
...
**Ejemplo:**
```python
from agentfx.fxString.string_evaluations import is_ipv6
...
**Ejemplo:**
```python
from agentfx.fxString.string_evaluations import is_json
...
**Ejemplo:**
```python
from agentfx.fxString.string_evaluations import is_uuid
...
**Ejemplo:**
```python
from agentfx.fxString.string_operations import slugify
...
**Ejemplo:**
```python
from agentfx.fxString.string_format import snake_to_camel
...
**Ejemplo:**
```python
from agentfx.fxString.string_operations import substitute
...
**Ejemplo:**
```python
from agentfx.fxString.string_operations import text_after
...
**Ejemplo:**
```python
from agentfx.fxString.string_operations import text_before
...
**Ejemplo:**
```python
from agentfx.fxString.string_operations import text_split
...
**Ejemplo:**
```python
from agentfx.fxString.string_evaluations import text_stats
...
**Ejemplo:**
```python
from agentfx.fxString.string_convertions import to_full_width
...
**Ejemplo:**
```python
from agentfx.fxString.string_convertions import to_half_width
...
**Ejemplo:**
```python
from agentfx.fxString.string_convertions import value_to_text
...
**Ejemplo:**
```python
from agentfx.fxString.string_operations import word_at
...
**Ejemplo:**
```python
from agentfx.fxString.string_format import word_wrap
...
**Ejemplo:**
```python
from agentfx.fxString.string_operations import wrap_text
