"""Shared module-loading helper for AgentFx sub-packages.
...
def auto_export(
    ...
    Args:
        package_name: Fully-qualified package name (e.g. ``"agentfx.fxDate"``).
    ...
    Example:
        >>> # inside agentfx/fxDate/__init__.py
        >>> from agentfx._loader import auto_export
        >>> auto_export("agentfx.fxDate", ["date_operations", ...], globals())
