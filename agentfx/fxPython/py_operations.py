"""
AgentFx - fxPython: Python Operations Module
...
def flatten_list(p_list: list[list]) -> list:
    ...
    Delegates to :func:`~agentfx.fxPython.py_itertools.flatten`.
    ...
    """
    from agentfx.fxPython.py_itertools import flatten
...
def calculate(expression_string):
    ...
    delegates to :func:`~agentfx.fxNumeric.calculator_functions.evaluate_expression`
