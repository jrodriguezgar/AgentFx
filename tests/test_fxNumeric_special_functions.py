...
from formulite.fxNumeric import special_functions as sf
...
class TestBernsteinPolynomial:
    ...
    def test_bernstein_basic(self):
        from formulite.fxNumeric.special_functions import bernstein_polynomial
...
class TestLegendrePolynomial:
    ...
    def test_p0(self):
        from formulite.fxNumeric.special_functions import legendre_polynomial
...
class TestAssociatedLegendre:
    ...
    def test_p10(self):
        from formulite.fxNumeric.special_functions import associated_legendre
...
class TestHermitePolynomial:
    ...
    def test_h0(self):
        from formulite.fxNumeric.special_functions import hermite_polynomial
...
class TestLaguerrePolynomial:
    ...
    def test_l0(self):
        from formulite.fxNumeric.special_functions import laguerre_polynomial
...
class TestChebyshevPolynomials:
    ...
    def test_t0(self):
        from formulite.fxNumeric.special_functions import chebyshev_polynomial_first
    ...
    def test_u0(self):
        from formulite.fxNumeric.special_functions import chebyshev_polynomial_second
...
class TestBernoulliNumbers:
    ...
    def test_b0(self):
        from formulite.fxNumeric.special_functions import bernoulli_number
...
class TestEulerNumbers:
    ...
    def test_e0(self):
        from formulite.fxNumeric.special_functions import euler_number
...
class TestDigamma:
    ...
    def test_at_1(self):
        from formulite.fxNumeric.special_functions import digamma
...
class TestRiemannZeta:
    ...
    def test_zeta_2(self):
        from formulite.fxNumeric.special_functions import riemann_zeta
...
class TestEllipticIntegrals:
    ...
    def test_k_zero(self):
        from formulite.fxNumeric.special_functions import elliptic_k
        assert elliptic_k(0) == pytest.approx(math.pi / 2)

    def test_e_zero(self):
        from formulite.fxNumeric.special_functions import elliptic_e
    ...
    def test_f_complete(self):
        from formulite.fxNumeric.special_functions import elliptic_f, elliptic_k
        # F(pi/2, k) == K(k)
...
class TestHypergeometric:
    ...
    def test_2f1_basic(self):
        from formulite.fxNumeric.special_functions import hypergeometric_2f1
    ...
    def test_1f1_exp(self):
        from formulite.fxNumeric.special_functions import hypergeometric_1f1
        # 1F1(1;1;1) = e
...
class TestAiryFunctions:
    ...
    def test_ai_zero(self):
        from formulite.fxNumeric.special_functions import airy_ai
        assert airy_ai(0) == pytest.approx(0.355028, rel=1e-3)

    def test_bi_zero(self):
        from formulite.fxNumeric.special_functions import airy_bi
        assert airy_bi(0) == pytest.approx(0.614927, rel=1e-3)

class TestSphericalBessel:

    def test_j0(self):
        from formulite.fxNumeric.special_functions import spherical_bessel_j
        # j_0(x) = sin(x)/x
        assert spherical_bessel_j(0, 1.0) == pytest.approx(math.sin(1.0), rel=1e-10)

    def test_y0(self):
        from formulite.fxNumeric.special_functions import spherical_bessel_y
        # y_0(x) = -cos(x)/x
...
class TestSphericalHarmonic:
    ...
    def test_y00(self):
        from formulite.fxNumeric.special_functions import spherical_harmonic_real
        # Y_0^0 = 1/sqrt(4pi)
