...
from formulite.fxString.string_operations import extract_mentions


class TestTextEntropy:

    def test_uniform(self):
        from formulite.fxString.string_evaluations import text_entropy
...
class TestStringValidationsPhase20b:
    ...
    def test_is_valid_e164_phone_valid(self):
        from formulite.fxString.string_evaluations import is_valid_e164_phone
    ...
    def test_check_password_strength_empty(self):
        from formulite.fxString.string_evaluations import check_password_strength
...
from formulite.fxString.string_convertions import ordinal_suffix
