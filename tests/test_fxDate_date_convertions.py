...
from formulite.fxString.string_convertions import hex_to_text, ordinal_suffix, text_to_hex
from formulite.fxString.string_operations import normalize_unicode


class TestUnixEpochDay:

    def test_epoch_zero(self):
        from formulite.fxDate.date_convertions import unix_epoch_day
...
class TestDateToExcelTimestamp:
    ...
    def test_noon(self):
        from formulite.fxDate.date_convertions import date_to_excel_timestamp
...
class TestTimeZoneOffset:
    ...
    def test_madrid_summer(self):
        from formulite.fxDate.date_convertions import time_zone_offset
