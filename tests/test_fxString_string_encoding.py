...
from formulite.fxString.string_operations import caesar_cipher


class TestCaesarCipher:

    def test_encrypt_basic(self):
        from formulite.fxString.string_encoding import caesar_cipher
...
class TestVigenereCipher:
    ...
    def test_encrypt(self):
        from formulite.fxString.string_encoding import vigenere_cipher
