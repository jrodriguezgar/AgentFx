...
from formulite.fxNumeric.statistics_functions import auto_correlation
...
class TestDFT:
    ...
    def test_constant_signal(self):
        from formulite.fxNumeric.transform_functions import dft
        result = dft([1, 1, 1, 1])
    ...
    def test_roundtrip(self):
        from formulite.fxNumeric.transform_functions import dft, idft
        signal = [1, 2, 3, 4]
...
class TestLaplaceTransform:
    ...
    def test_unit_step(self):
        from formulite.fxNumeric.transform_functions import laplace_transform_numerical
        # L{1} = 1/s
        result = laplace_transform_numerical(lambda t: 1, 1.0)
        assert result == pytest.approx(1.0, rel=0.05)

    def test_inverse(self):
        from formulite.fxNumeric.transform_functions import inverse_laplace_gaver_stehfest
        # L^{-1}{1/s} = 1
...
class TestConvolution:
    ...
    def test_basic(self):
        from formulite.fxNumeric.transform_functions import convolution
...
class TestCrossCorrelation:
    ...
    def test_autocorrelation_peak(self):
        from formulite.fxNumeric.transform_functions import auto_correlation
        signal = [1, 0, 1]
...
class TestZTransform:
    ...
    def test_basic(self):
        from formulite.fxNumeric.transform_functions import z_transform_eval
