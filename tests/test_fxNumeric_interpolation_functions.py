...
class TestLagrangeInterpolation:
    ...
    def test_quadratic(self):
        from agentfx.fxNumeric.interpolation_functions import lagrange_interpolation
...
class TestBilinearInterpolation:
    ...
    def test_center(self):
        from agentfx.fxNumeric.interpolation_functions import bilinear_interpolation
...
class TestNewtonDividedDifference:
    ...
    def test_quadratic(self):
        from agentfx.fxNumeric.interpolation_functions import newton_divided_difference
...
class TestCubicSplineNatural:
    ...
    def test_quadratic_data(self):
        from agentfx.fxNumeric.interpolation_functions import cubic_spline_natural
