...
class TestLagrangeInterpolation:
    ...
    def test_quadratic(self):
        from formulite.fxNumeric.interpolation_functions import lagrange_interpolation
...
class TestBilinearInterpolation:
    ...
    def test_center(self):
        from formulite.fxNumeric.interpolation_functions import bilinear_interpolation
...
class TestNewtonDividedDifference:
    ...
    def test_quadratic(self):
        from formulite.fxNumeric.interpolation_functions import newton_divided_difference
...
class TestCubicSplineNatural:
    ...
    def test_quadratic_data(self):
        from formulite.fxNumeric.interpolation_functions import cubic_spline_natural
